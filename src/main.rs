...
impl OpenAlgoMcp {
    ...
    fn tool_definitions() -> Vec<Tool> {
        vec![
            ...
            Self::make_tool("place_basket_order", "Place multiple orders in a basket. orders: array of order objects.", json!({"type":"object","required":["orders"],"properties":{"orders":{"type":"array","items":{"type":"object","properties":{"symbol":{"type":"string"},"action":{"type":"string"},"quantity":{"type":"integer"},"exchange":{"type":"string"},"price_type":{"type":"string"},"product":{"type":"string"}}}},"strategy":{"type":"string","default":"Rust"}}})),
            ...
            Self::make_tool("place_options_multi_order", "Place a multi-leg options order (spreads, iron condor). Required: strategy, underlying, exchange, legs.", json!({"type":"object","required":["strategy","underlying","exchange","legs"],"properties":{"strategy":{"type":"string"},"underlying":{"type":"string"},"exchange":{"type":"string"},"legs":{"type":"array","items":{"type":"object","properties":{"offset":{"type":"string"},"option_type":{"type":"string"},"action":{"type":"string"},"quantity":{"type":"integer"}}}},"expiry_date":{"type":"string"}}})),
            ...
            Self::make_tool("calculate_margin", "Calculate margin requirements.", json!({"type":"object","required":["positions"],"properties":{"positions":{"type":"array","items":{"type":"object","properties":{"symbol":{"type":"string"},"exchange":{"type":"string"},"action":{"type":"string"},"quantity":{"type":"integer"},"product":{"type":"string"}}}}}})),
            // Market Data
            ...
            Self::make_tool("get_multi_quotes", "Get quotes for multiple symbols.", json!({"type":"object","required":["symbols"],"properties":{"symbols":{"type":"array","items":{"type":"object","properties":{"symbol":{"type":"string"},"exchange":{"type":"string"}}}}}})),
